...
myProfile["NamaGue"] = KiaProfile.displayName
myProfile["Status"] = KiaProfile.statusMessage
myProfile["FotoJelek"] = KiaProfile.pictureStatus
#
def restartBot():
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                Kia.sendMessage(op.param1, "Hi  {} terima kasih telah yaudah iya".format(str(Kia.getContact(op.param1).displayName)))
        if op.type == 13:
...
#
                if text.lower() == 'help':
                    ...
                    Kia.sendContact(to, "Ubb1949ac6f0ec0e6a40c08a0ee845690")
...
#
                    ...
                    start = time.time()
                    Kia.sendMessage(to, "Tunggu bentar")
                    ...
                    Kia.sendMessage(to, "Bacot lu {}".format(str(runtime)))
...
#
                    ...
                    Kia.sendMessage(to, "➸ auto add on")
                elif text.lower() == 'autoadd off':
                    settings["autoAdd"] = False
                    Kia.sendMessage(to, "➸ auto add off")
                elif text.lower() == 'autojoin on':
                    settings["autoJoin"] = True
                    Kia.sendMessage(to, "➸ auto join on")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    Kia.sendMessage(to, "➸ auto joιn off")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    Kia.sendMessage(to, "➸ auto leave on")
                elif text.lower() == 'autoleave off':
                    settings["autoLeave"] = False
                    Kia.sendMessage(to, "➸ auto leave off")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    Kia.sendMessage(to, "➸ auto read on")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    Kia.sendMessage(to, "➸ auto read off")
                elif text.lower() == 'checksticker on':
                    settings["checkSticker"] = True
                    Kia.sendMessage(to, "➸ cek detail stiker on")
                elif text.lower() == 'checksticker off':
                    settings["checkSticker"] = False
                    Kia.sendMessage(to, "➸ cek detail stiker off")
                elif text.lower() == 'detectmention on':
                    settings["detectMention"] = True
                    Kia.sendMessage(to, "➸ detect mention on")
                elif text.lower() == 'detectmention off':
                    settings["detectMention"] = False
                    Kia.sendMessage(to, "➸ detect mention off")
#
                elif text.lower() == 'me':
                    ...
                    Galank.sendMessage(msg.to,"[NamaGue]\n" + me.displayName)
                elif text.lower() == 'mybio':
                    me = Kia.getContact(KiaMID)
                    Kia.sendMessage(msg.to,"[Status]\n" + me.statusMessage)
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            Kia.sendMessage(msg.to, "BERHASIL")
                        except:
                            Kia.sendMessage(msg.to, "GAGAL")
                elif text.lower() == 'restoreprofile':
                    try:
                        KiaProfile.displayName = str(myProfile["Nama Gue"])
                        KiaProfile.statusMessage = str(myProfile["Status"])
                        KiaProfile.pictureStatus = str(myProfile["FotoJelek"])
...
#
                    ...
                    for target in targets:
                        try:
                            ...
                            Kia.sendMessage(msg.to,"TARGET ADD")
                            break
                        except:
                            Kia.sendMessage(msg.to,"GAGAL")
                            break
                    ...
                    for target in targets:
                        try:
                            ...
                            Kia.sendMessage(msg.to,"TARGET DI HAPUS")
                            break
                        except:
                            Kia.sendMessage(msg.to,"GAGAL")
                            break
                    ...
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            ...
                            Kia.sendMessage(msg.to,"REPLY AKTIF")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            Kia.sendMessage(msg.to,"REPLY OFF")
#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            Kia.sendMessage(to, "QR grup gabisa dibuka slur, coba ketik {}openqr".format(str(settings["keyCommand"])))
                elif text.lower() == 'groupticket on':
                    if msg.toType == 2:
                        group = Kia.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            Kia.sendMessage(to, "➸ QR grup udah kebuka")
                        else:
                            group.preventedJoinByTicket = False
                            Kia.updateGroup(group)
                            Kia.sendMessage(to, "➸ Berhasil membuka QR grup")
                elif text.lower() == 'groupticket off':
                    if msg.toType == 2:
                        group = Kia.getGroup(to)
                        if group.preventedJoinByTicket == True:
                            Kia.sendMessage(to, "➸ QR grup udah ditutup")
                        else:
                            group.preventedJoinByTicket = True
                            Kia.updateGroup(group)
                            Kia.sendMessage(to, "➸ Berhasil menutup hati, eh QR grup")
                elif text.lower() == 'groupinfo':
                    group = Kia.getGroup(to)
                    try:
                        gCreator = group.creator.displayName
                    except:
                        gCreator = "Ga ada slur"
                    ...
                    ret_ += "\n║➸  Yang Bikin : {}".format(str(gCreator))
                    ...
                    if msg.toType == 2:
                        ...
                        Kia.sendMessage(to, str(ret_))
                                ...
                                try:
                                    ...
                                    del cctv['ceeduk'][receiver]
                                except:
                                    pass
                                cctv['point'][receiver] = msg.id
                                cctv['sidermem'][receiver] = ""
                                cctv['ceeduk'][receiver]=True
                elif text.lower() == 'offread':
                                if msg.to in cctv['point']:
                                    cctv['ceeduk'][receiver]=False
                                    Kia.sendText(receiver, cctv['sidermem'][msg.to])

                elif text.lower() == 'welcome on':
                   if settings["Sambutan"] == True:
                       if settings["lang"] == "JP":
                           Kia.sendMessage(msg.to,"➸ udah aktif cok")
                   else:
                       settings["Sambutan"] = True
                       if settings["lang"] == "JP":
                           Kia.sendMessage(msg.to,"➸ sambutan udah diaktifkan cok")

                elif text.lower() == 'welcome off':
                   if settings["Sambutan"] == False:
                       if settings["lang"] == "JP":
                          Kia.sendMessage(msg.to,"➸ udah mati cok")
                   else: 
                       settings["Sambutan"] = False
                       if settings["lang"] == "JP":
                           Kia.sendMessage(msg.to,"➸ sambutan udah dimatikan cok")
...
#
                            ...
                            Kia.sendMessage(to, "➸ kirim gambarnya cok")
...
#
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                Kia.sendMessage(msg.to,"lurking aktif")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to not in read['readPoint']:
                        Kia.sendMessage(msg.to,"lurking mati")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        Kia.sendMessage(msg.to, "lurking blm aktif jgn di reset bego")
                    ...
                    if receiver in read['readPoint']:
                        ...
                        Kia.sendMessage(receiver,"lurking belum di atur")
                    ...
                    cctv['ceeduk'][msg.to]=True 
                    settings["Sider"] = True
                    Kia.sendMessage(msg.to,"cek sider on")

                elif text.lower() == 'sider off':
                    if msg.to in cctv['point']:
                       cctv['ceeduk'][msg.to]=False
                       settings["Sider"] = False
                       Kia.sendMessage(msg.to,"cek sider off")
                    else:
                        Kia.sendMessage(msg.to,"cek sider off")
...
#                    print  ("ok")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            ...
                            if msg.toType == 2:
                                ...
                                num = int(strnum)
                                Kia.sendMessage(to, "Berhasil undang ke telepon grup")
                    ...
                    ret_ += "\n╠ Ultah : {}".format(str(data["data"]["ultah"]))
                    ...
                    with requests.session() as web:
                        ...
                        try:
                            ...
                            ret_ += "\n╠ Follower : {}".format(format_number(data["user"]["followed_by"]["count"]))
                            ...
                            Kia.sendMessage(to, "Wah ga ketemu cok")
                    ...
                    with requests.session() as web:
                        ...
                        try:
                            ...
                            Kia.sendMessage(to, "Musik ga ada cok")
                    ...
                    with requests.session() as web:
                        ...
                        try:
                            ...
                            Kia.sendMessage(to, "Lirik ga ada cok")
                ...
                if settings["checkSticker"] == True:
                    ...
                    if settings["changePicture"] == True:
                        ...
                        Kia.sendMessage(to, "Foto profil udah diubah ")
                    if msg.toType == 2:
                        if to in settings["changeGroupPicture"]:
                            path = Kia.downloadObjectMsg(msg_id)
                            settings["changeGroupPicture"].remove(to)
                            Kia.updateGroupPicture(to, path)
                            Kia.sendMessage(to, "Foto group udah diubah")
...
#
                        ...
                        for mention in mentionees:
                            if KiaMID in mention["M"]:
                              if settings["detectMention"] == True:
                                ...
                                Kia.sendMessage(to, " RESPON \n Kenapa ngetag terus \n minta di cipok ya awokwok \n Tutuy's ")
        ...
        if op.type == 17:
           ...
           if settings["Sambutan"] == True:
             ...
             Kia.sendMessage(op.param1,"╔══[ Hi.." + Kia.getContact(op.param2).displayName + "  ]\n║➸ Welcome cok -> " + str(ginfo.name) + " <- " +"\n║➸ bukan tempat bokep ya bgst\n║➸ semoga betah cok\n╚══[ ➣salken Tutuy's  ]")
        ...
        if op.type == 15:
           ...
           if settings["Sambutan"] == True:
             ...
             image = "http://dl.profile.line.naver.jp/" + contact.pictureStatus
             Kia.sendImageWithURL(op.param1,image)
             Kia.sendMessage(op.param1,"╔══[ -_- " + Kia.getContact(op.param2).displayName + " ]\n║➸  lah tolol malah leave\n╚══[ Loss Tutuy's ]")
#
        if op.type == 55:
                    ...
                    if op.param1 in cctv['point']:
                        ...
                        if Name in cctv['sidermem'][op.param1]:
                            ...
                            if " " in Name:
                                nick = Name.split(' ')
                                if len(nick) == 2:
                                    Kia.sendMessage(op.param1, "╔══[ hai cok " + "-> " + nick[0] + " <- " + "]\n║ Jangan sider terus napa cok \n╚══[ Awokwokwok ]")
                                    time.sleep(0.2)
                                    mentionMembers(op.param1,[op.param2])
                                else:
                                    Kia.sendMessage(op.param1, "╔══[ Assalamualaikum" + "☞" + nick[1] + " ☜" + "]\n║ Gabung sini cok\n╚══[ Awokowokwok]")
                                    time.sleep(0.2)
                                    mentionMembers(op.param1,[op.param2])
                            else:
                                Kia.sendMessage(op.param1, "╔══[ Hayolo " + " -> " + Name + " <- " + " ]\n║ sider terosss\n╚══[ DAH LAH MLZ ] ")
                                time.sleep(0.2)
                                mentionMembers(op.param1,[op.param2])
                    else:
                        pass
